# Generated by Django 5.1 on 2024-11-28 17:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('chat', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='chatApp.chat')),
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('friend', 'user'), name='unique_friendship_reverse')],
